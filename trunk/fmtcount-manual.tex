...
\item When the \oarg{gender} optional argument is omitted, no ignoring of spaces following the final argument
  occurs. So both \verb"\ordinal{section} !"  and \verb"\ordinal{section}[m] !" will produce:
  \arabic{section}\textsuperscript{rd} ! See \S~\ref{sec:tailing-oarg}.
\end{enumerate}
...
\section{Handling of spaces with tailing optional argument}
...
\begin{itemize}
\item ``x\cs{odinalnum\{2\}}\verb*! !\texttt{x}'' will be typeset to ``x\ordinalnum{2}\verb*! !x'', while
